...
class regController {
    async reg(req, res) {    
        if(req.cookies.userid) {
            ...
            const {nickname, email, passwords, age} = req.body
            ...
            try{
                if(email == reemail.rows[0].email) {
                    ...
                    const newUser = await db.query(`INSERT INTO users (nickname, email, passwords, age) values ($1, $2, $3, $4) returning *`, [nickname, email, passwords, age]) 
